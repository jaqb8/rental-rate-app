export default {
  ...
  Sidebar: {
    ...
    addNewLandlordDescription: "Wprowadź szczegóły nowego wynajmującego.",
  ...
  AddReviewPage: {
    ...
    reviewContentDescription: "Podziel się swoim doświadczeniem z wynajmującym",
    reviewContentDescription2:
      "Podaj szczegóły swojego doświadczenia z wynajmującym.",
    rating: "Ocena",
    ratingDescription: "Oceń swojego wynajmującego od 1 do 5 gwiazdek.",
    submit: "Dodaj opinię",
    processing: "Przetwarzanie...",
    contentMessage: "Treść musi mieć co najmniej 10 znaków.",
    pickRating: "Wybierz ocenę",
  },
} as const;
